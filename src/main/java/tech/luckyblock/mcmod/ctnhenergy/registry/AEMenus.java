...
public class AEMenus {
    ...
    public static final Supplier<MenuType<QuantumComputerMenu>> QUANTUM_COMPUTER = create("jiuzhang_quantum_computer",
            QuantumComputerMenu::new, QuantumComputerMENetworkPortBlockEntity.class);
