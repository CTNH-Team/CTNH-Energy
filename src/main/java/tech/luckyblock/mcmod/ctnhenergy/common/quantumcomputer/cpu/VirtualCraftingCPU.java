...
public class VirtualCraftingCPU implements ICraftingCPU {
    ...
    private final QuantumComputerCluster cluster;
    public final VirtualCraftingCPULogic craftingLogic = new VirtualCraftingCPULogic(this);
    public GenericStack finalOutput;

    public VirtualCraftingCPU(QuantumComputerCluster cluster, ICraftingPlan plan) {
        this.cluster = cluster;
        this.plan = plan;
    }

    protected VirtualCraftingCPU(QuantumComputerCluster cluster, long fakeStorage) {
        this.cluster = cluster;
        this.plan = null;
