...
public class VirtualCraftingCPULogic {
     ...
     * Inventory.
     */
    private final ListCraftingInventory inventory = new ListCraftingInventory(VirtualCraftingCPULogic.this::postChange);
    /**
    ...
    public VirtualCraftingCPULogic(VirtualCraftingCPU cpu) {
        this.cpu = cpu;
    }
    ...
    public ICraftingSubmitResult trySubmitJob(
        ...
        if (requester != null) {
            var linkRequester = new CraftingLink(CraftingCpuHelper.generateLinkData(craftId, false, true), requester);
