...
public class ImportExportBus {
    ...
    public static void common(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world().showSection(util.select().fromTo(2, 1, 4, 4, 1, 4), Direction.DOWN);
        scene.idle(20);
        ...
        scene.idle(10);
        scene.world().showSection(util.select().position(1, 1, 1), Direction.NORTH);
        scene.idle(30);
        scene.overlay().showText(60)
        ...
        scene.overlay().showControls(util.vector().blockSurface(util.grid().at(2, 1, 3), Direction.UP), Pointing.DOWN, 40)
                ...
                .withItem(AEItems.CERTUS_QUARTZ_CRYSTAL.asItem().getDefaultInstance());
        scene.idle(40);
        scene.world().showSection(util.select().position(4, 1, 2), Direction.NORTH);
        scene.idle(10);
    ...
    public static void transport(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world().showSection(util.select().fromTo(1, 2, 0, 1, 2, 3), Direction.DOWN);
        scene.idle(20);
    }
}
