...
public class PatternProvider {
    ...
    public static void common(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay().showText(40)
                ...
                .attachKeyFrame();
        scene.idle(60);
        scene.overlay().showControls(util.vector().blockSurface(util.grid().at(2, 2, 3), Direction.UP), Pointing.DOWN, 20)
                .rightClick()
    ...
    public static void interaction(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay().showText(40)
                ...
                .attachKeyFrame();
        scene.idle(60);
        scene.overlay().showControls(util.vector().blockSurface(util.grid().at(1, 1, 1), Direction.UP), Pointing.DOWN, 40)
                .rightClick()
