...
public final class ResultReflection {
    ...
    private static final String BASE = "appeng.integration.modules.emi.AbstractRecipeHandler$Result";
    ...
    static {
        try {
            ...
            PARTIALLY_CRAFTABLE_CTOR = PARTIALLY_CRAFTABLE_CLASS.getDeclaredConstructor(
