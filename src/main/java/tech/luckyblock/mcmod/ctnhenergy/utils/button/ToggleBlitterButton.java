...
public class ToggleBlitterButton extends BlitterButton implements ITooltip {
    ...
    public ToggleBlitterButton(Blitter on, Blitter off, Component displayName,
    ...
    public ToggleBlitterButton(Blitter on, Blitter off, Listener listener) {
        super(null);
        this.blitterOn = on;
        this.blitterOff = off;
    ...
    protected Blitter getBlitter() {
        return this.state ? this.blitterOn : this.blitterOff;
    }
